...
```
All subjects and objects we call nodes and the predicate we call edges.
What we want to do is to search such an ontology strucure using a queary and where this structure is spread over several servers.
